...
class InfiniteVocabEmbedding(nn.Module):
    ...
    def _hook_vocab_on_load_state_dict(
        ...
        if not self.is_lazy():
            incoming_vocab = state_dict.pop(prefix + "vocab") # pretrained (inhibitory) -> length 1458 (based on unit embed)
            ...
            for word, index in list(self.vocab.items()):
                ...
                remap_indices.append(incoming_vocab.pop(word)) # pack everything in
